  ...
  <div class="flex-md-row holder  noscrollbar noscrollbarfire" style="height: 90vh; overflow-y: scroll;">
    <div class="container-fluid mt-4">
      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          <h4 class="fw-bold">Applied Applicants</h4>
        </div>
     
      </div>
      @if($applicants->count() > 0)
      <div class="col-sm-12">
        <form action="{{ route('employer.Aplicantsearch') }}" method="post" class="mb-3">
            @csrf
    ...
    @endif
      ...
      <div class="card mt-4 shadow-sm">
        ...
        <div class="card-body table-responsive noscrollbar noscrollbarfire">
           ...
           <table class="table table-hover align-middle text-nowrap">
            ...
            <tr>
              ...
              @php
              $applicantjob = ApplicantJob::where([['job_id',$applicant->occupation->id],['applicant_id',$applicant->applicant->id]])->first();
             @endphp
             ...
             @endif
              <td>
                <a href="{{ route('employer.applicantDetails',['applicantid' => $applicant->applicant->id, 'jobid'=>$applicant->occupation->id]) }}" class="btn btn-sm btn-outline-info">View More</a>
              </td>
            </tr>
            @endforeach
        ...
        <div>
          ...
          <h5 class="text-info text-center">No any applicant yet</h5>
          @endif
